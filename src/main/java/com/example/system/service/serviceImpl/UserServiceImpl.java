...
import com.example.system.dao.UserRoleMapper;
...
public class UserServiceImpl extends BaseService<User> implements UserService {
    ...
    @Override
    public List<User> findManagerList(User user) {
        try {
            if (StringUtils.isNotBlank(user.getUsername())) {
                user.setUsername(user.getUsername().toLowerCase());
            }
            return this.userMapper.findManagerList(user);
        } catch (Exception e) {
            e.printStackTrace();
            return new ArrayList<>();
        }
    ...
    @Override
    public String findManagerNameById(String administrator) {
        return  this.userMapper.findManagerNameById(administrator);
    }
