...
import com.example.common.domain.ResponseBo;
import com.example.common.util.DealPWD;
...
public class UserController extends BaseController {
    ...
    public ResponseBo getUser(Long userId) {
        try {
            ...
            if (StringUtils.isNotBlank(user.getAdministrator())){
                String  managerName =  this.userService.findManagerNameById(user.getAdministrator());
    ...
    @RequestMapping("user/managerList")
    @ResponseBody
    public Map<String, Object> managerList(QueryRequest request, User user) {
        if (StringUtils.isBlank(user.getDsRegionId())) {
            user.setDsRegionId(super.getCurrentUser().getRegionId());
        }
        return super.selectByPageNumSize(request, () -> this.userService.findManagerList(user));
    }
